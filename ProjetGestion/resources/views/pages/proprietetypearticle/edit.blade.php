                    ...
                    <div class="card-body table-responsive p-0 table-striped" style="max-height: 300px;">
                        <table class="table table-head-fixed text-nowrap">
                            ...
                            <form action="{{ route('admin.proprietetypearticle.update', [$type_article->id, $propriete_type_article->id]) }}" method="POST">
                                ...
                                <tr>
                                    <td class="row">
                                        <input type="text" class="form-control w-50 @error('nom') is-invalid @enderror" name="nom" value="{{ $propriete_type_article->nom }}">
                                        @error("nom")
                                    ...
                                    <td class="text-center">
                                        <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success" >
                                            <input type="checkbox" class="custom-control-input" name="estObligatoire" id="estObligatoire" @if($propriete_type_article->estObligatoire) checked @endif>                                           >
                            ...
                            @foreach($autres_proprietes as $proprietesTypeArticle)
                                <tr>
